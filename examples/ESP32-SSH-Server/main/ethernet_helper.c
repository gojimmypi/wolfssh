...
/*
 * Based on Public Domain Examples.
 *
 * Credit Espressif:
 *  https://github.com/espressif/esp-idf/blob/release/v4.4/examples/ethernet/basic/main/ethernet_example_main.c
 **/
...
/* #define CONFIG_EXAMPLE_USE_SPI_ETHERNET true */
...
void init_ethernet(void)
    ...
    for (int i = 0; i < CONFIG_EXAMPLE_SPI_ETHERNETS_NUM; i++) {
        ...
        */
        ESP_ERROR_CHECK(esp_eth_ioctl(eth_handle_spi[i],
            ETH_CMD_S_MAC_ADDR,
            (uint8_t[]) {
